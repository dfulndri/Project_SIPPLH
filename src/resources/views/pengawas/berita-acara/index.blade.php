...
<div class="card-panel">
  <div class="table-responsive">
    <table class="table sipplh-table">
      <thead><tr><th>Nomor BA</th><th>No. Pengaduan</th><th>Terlapor</th><th>Tanggal Terbit</th><th>Status</th><th>Aksi</th></tr></thead>
      <tbody>
        ...
        <tr>
          ...
          <td><span class="badge bg-{{ $ba->status == 'final' ? 'success' : 'warning' }}">{{ ucfirst($ba->status) }}</span></td>
          <td><a href="{{ route('pengawas.berita-acara.show', $ba) }}" class="btn btn-xs btn-outline-secondary"><i class="bi bi-eye"></i></a></td>
        </tr>
        @empty
        <tr><td colspan="6"><div class="empty-state"><i class="bi bi-file-earmark-text"></i>Belum ada berita acara</div></td></tr>
        @endforelse
      </tbody>
    </table>
  </div>
