<nav id="sidebar">
    ...
    <div class="sb-nav">
        ...
        <a href="#pelaporCollapse" class="sb-link {{ request()->routeIs('admin.pelapor.*') ? 'active' : '' }}"
            data-bs-toggle="collapse" aria-expanded="{{ request()->routeIs('admin.pelapor.*') ? 'true' : 'false' }}">
        ...
        <a href="#terlaporCollapse" class="sb-link {{ request()->routeIs('admin.terlapor.*') ? 'active' : '' }}"
            data-bs-toggle="collapse" aria-expanded="{{ request()->routeIs('admin.terlapor.*') ? 'true' : 'false' }}">
        ...
        <div class="collapse {{ request()->routeIs('admin.terlapor.*') ? 'show' : '' }}" id="terlaporCollapse">
            ...
            <a href="{{ route('admin.terlapor.index', ['jenis' => 'lembaga']) }}"
                class="sb-link sb-link-sub {{ request()->is('admin/terlapor*') && request('jenis') == 'lembaga' ? 'active' : '' }}">
                <i class="bi bi-people-fill"></i><span>Lembaga / Organisasi</span>
            </a>
        ...
        <a href="{{ route('admin.pengaduan.index') }}"
            ...
            @if ($masuk > 0)
                <span class="sb-badge">{{ $masuk }}</span>
            @endif
        </a>
